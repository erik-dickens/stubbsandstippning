...
export const predictionItem = pgTable(
	'prediction_item',
	{
		id: integer()
			.primaryKey()
			.generatedByDefaultAsIdentity({
				name: 'prediction_item_id_seq',
				startWith: 1,
				increment: 1,
				minValue: 1,
				maxValue: 2147483647,
...
export const championship = pgTable(
	...
	(table) => [unique('championship_name_key').on(table.name)]
)
